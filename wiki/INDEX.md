# Agent Factory Wiki -- Index

> The knowledge base for building production-quality AI agents.

## How to Use This Wiki

This wiki is the structured reference layer for the Agent Factory: meta-skills and tooling can retrieve articles here to ground answers in shared vocabulary, patterns, and research summaries. Read it alongside the **23-module course** (`../course/README.md`): modules map to concept articles, while research notes deepen specific topics. Start from a concept when you are designing or reviewing an agent; use research articles for comparisons, citations, and architecture debates; use examples as concrete anchors for what to emulate or avoid.
...
- [Planning Strategies](concepts/planning-strategies.md)
...
- [Prompt Engineering for Agents](concepts/prompt-engineering-for-agents.md)
...
- [Lilian Weng Survey](research/lilian-weng-survey.md)
...
- [Agent Evaluation Methods](research/agent-evaluation-methods.md)
- [Production Case Studies](research/production-case-studies.md)
...
- [LangGraph ReAct agent](examples/good/langgraph-react-agent.md)
- [CrewAI research team](examples/good/crewai-research-team.md)
- [OpenAI Agents customer service](examples/good/openai-agents-customer-service.md)
- [gstack browse daemon](examples/good/gstack-browse-daemon.md)
- [Anthropic computer use](examples/good/anthropic-computer-use.md)
- [Goose extensible agent](examples/good/goose-extensible-agent.md)
- [phidata knowledge agent](examples/good/phidata-knowledge-agent.md)
- [Simple function calling](examples/good/simple-function-calling.md)
- [MCP tool server](examples/good/mcp-tool-server.md)
- [Multi-agent code review](examples/good/multi-agent-code-review.md)
- [Hermes self-improving](examples/good/hermes-self-improving.md)
- [Paperclip agent team](examples/good/paperclip-agent-team.md)
- [AutoAgent harness loop](examples/good/autoagent-harness-loop.md)
- [Ralph PRD completion](examples/good/ralph-prd-completion.md)

### Bad (8 anti-pattern examples)

- [God agent](examples/bad/god-agent.md)
- [Over-tooled agent](examples/bad/over-tooled-agent.md)
- [Chatbot pretending to be agent](examples/bad/chatbot-pretending-to-be-agent.md)
- [Framework soup](examples/bad/framework-soup.md)
- [No guardrails agent](examples/bad/no-guardrails-agent.md)
- [Infinite loop agent](examples/bad/infinite-loop-agent.md)
- [Context stuffing agent](examples/bad/context-stuffing-agent.md)
- [Premature autonomy agent](examples/bad/premature-autonomy-agent.md)
